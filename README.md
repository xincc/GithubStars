...
* [iOS](#ios)
	...
	* [Swift](#ios-swift)
		* [Code Style](#ios-swift-code-style)
		* [Transitions](#ios-swift-transition)
		* [String](#ios-swift-string)
		* [Utils](#ios-swift-utils)
		* [Scroll](#ios-swift-scroll)
		* [TabBar](#ios-swift-tab-bar)
		* [Framework](#ios-swift-framework)
...
* <a name="ios-objective-c"></a>**Objective-C**
    ...
    * <a name="ios-objective-c-model"></a>**Model**
    ...
    * <a name="ios-objective-c-live"></a>**Live**
    ...
    * <a name="ios-objective-c-test"></a>**Test**
        ...
        * Find memory leaks in your iOS app at develop time. [Zepo/MLeaksFinder](https://github.com/Zepo/MLeaksFinder) ⭐️⭐️
...
* <a name="ios-swift"></a>**Swift** [OpenSource](https://github.com/apple/swift) ⭐️⭐️⭐️⭐️⭐️
    ...
    * <a name="ios-swift-CollectionView"></a>**CollectionView**
	...
	* <a name="ios-swift-Transitions"></a>**Transitions**
        ...
        * This is a Swift based demo project to show how to make the transition Pinterest liked. [demonnico/PinterestSwift](https://github.com/demonnico/PinterestSwift) ⭐️⭐️
    ...
    * <a name="ios-swift-Camera"></a>**Camera**
    ...
    * <a name="ios-swift-StoreKit"></a>**StoreKit**
    ...
    * <a name="ios-swift-Storage"></a>**Storage**
        ...
        * A powerful, protocol-oriented library for working with the keychain in Swift. [matthewpalmer/Locksmith](https://github.com/matthewpalmer/Locksmith) ⭐️⭐️⭐️
        * Modern Swift API for NSUserDefaults [radex/SwiftyUserDefaults](https://github.com/radex/SwiftyUserDefaults) ⭐️⭐️⭐️⭐️


    * <a name="ios-swift-Cache"></a>**Cache**
        * A caching and consistency solution for immutable models. [linkedin/RocketData](https://github.com/linkedin/RocketData) ⭐️⭐️
        * The missing light persistence layer for Swift.  [nickoneill/Pantry](https://github.com/nickoneill/Pantry) ⭐️⭐️


    * <a name="ios-swift-Network"></a>**Network**
        * Elegant HTTP Networking in Swift.  [Alamofire/Alamofire](https://github.com/Alamofire/Alamofire) ⭐️⭐️⭐️⭐️⭐️
        * Network abstraction layer written in Swift. [Moya/Moya](https://github.com/Moya/Moya) ⭐️⭐️⭐️⭐️⭐️
        * AlamofireImage is an image component library for Alamofire.  [Alamofire/AlamofireImage](https://github.com/Alamofire/AlamofireImage) ⭐️⭐️⭐️
        * A lightweight, pure-Swift library for downloading and caching images from the web.[Kingfisher](https://github.com/onevcat/Kingfisher) ⭐️⭐️⭐️⭐️
        * Send email to any SMTP server like a boss, in Swift and cross-platform.  [onevcat/Hedwig](https://github.com/onevcat/Hedwig) ⭐️⭐️
        * Websockets in swift for iOS and OSX.  [daltoniam/Starscream](https://github.com/daltoniam/Starscream) ⭐️⭐️⭐️  <sup>sockets</sup>
        * Socket framework for Swift using the Swift Package Manager. Works on iOS, macOS, and Linux. [URL](https://github.com/IBM-Swift/BlueSocket) ⭐️⭐️
        * 🐤Dynamically Mock server behaviors and responses in Swift  [devlucky/Kakapo](https://github.com/devlucky/Kakapo)  ⭐️⭐️⭐️  <sup>Mock</sup>
        * A Swift HTTP / HTTPS networking library just incidentally execute on machines. [johnlui/Pitaya](https://github.com/johnlui/Pitaya) ⭐️⭐️ <sup>中文</sup>
        * The civilized way to write REST API clients for iOS / macOS [bustoutsolutions/siesta](https://github.com/bustoutsolutions/siesta) ⭐️⭐️⭐️  <sup>REST</sup>


    * <a name="ios-swift-Crypto"></a>**Crypto**
        * CryptoSwift is a growing collection of standard and secure cryptographic algorithms implemented in Swift. [krzyzanowskim/CryptoSwift](https://github.com/krzyzanowskim/CryptoSwift) ⭐️⭐️⭐️⭐️
        * Heimdall is a wrapper around the Security framework for simple encryption/decryption operations. [henrinormak/Heimdall](https://github.com/henrinormak/Heimdall) ⭐️⭐️


    * <a name="ios-swift-tab-Router"></a>**Router**
        * ⛵️ Elegant URL Routing for Swift.  [devxoul/URLNavigator](https://github.com/devxoul/URLNavigator) ⭐️⭐️
        * A framework for handle the call between view controllers in iOS.  [douban/FRDIntent](https://github.com/douban/FRDIntent) ⭐️⭐️
        * Swift 路由框架：iOS 基于页面、模块的路由框架，解耦神器。 [Fnoz/FNUrlRoute](https://github.com/Fnoz/FNUrlRoute) ⭐️


    * <a name="ios-swift-tab-Hook"></a>**Hook**
        * PoC of function hooking in Swift. [rodionovd/SWRoute](https://github.com/rodionovd/SWRoute) ⭐️⭐️
        * Swift-friendly API for a set of powerful Objective C runtime functions. [URL](https://github.com/marmelroy/ObjectiveKit) ⭐️⭐️


    * <a name="ios-swift-Algorithm"></a>**Algorithm**
        * A Swift library that uses the Accelerate framework to provide high-performance functions for matrix math, digital signal processing, and image manipulation. [mattt/Surge](https://github.com/mattt/Surge) ⭐️⭐️⭐️⭐️⭐️
        * Algorithms and data structures in Swift, with explanations! [raywenderlich/swift-algorithm-club](https://github.com/raywenderlich/swift-algorithm-club) ⭐️⭐️⭐️⭐️⭐️
        * Fast ordered collections for Swift using in-memory B-trees.  [lorentey/BTree](https://github.com/lorentey/BTree) ⭐️⭐️
        * A toolbox of AI modules written in Swift: Graphs/Trees, Support Vector Machines, Neural Networks, PCA, K-Means, Genetic Algorithms.  [KevinCoble/AIToolbox](https://github.com/KevinCoble/AIToolbox) ⭐️⭐️⭐️⭐️⭐️  <sup>machine learning</sup>


    * <a name="ios-swift-Test"></a>**Test**
        * Shows FPS, CPU usage, app and iOS versions above the status bar and report FPS and CPU usage via delegate.  [dani-gavrilov/GDPerformanceView-Swift](https://github.com/dani-gavrilov/GDPerformanceView-Swift) ⭐️⭐️⭐️
        * Execute tests in parallel on multiple iOS Simulators.  [plu/pxctest](https://github.com/plu/pxctest) ⭐️⭐️
        * WKZombie is a Swift framework for iOS/OSX to navigate within websites and collect data without the need of User Interface or API, also known as Headless browser. It can be used to run automated tests / snapshots and manipulate websites using Javascript. [mkoehnke/WKZombie](https://github.com/mkoehnke/WKZombie) ⭐️
        * Small library to easily run your tests directly within a Playground. [WhiskerzAB/PlaygroundTDD](https://github.com/WhiskerzAB/PlaygroundTDD) ⭐️⭐️


    * <a name="ios-swift-Debug"></a>**Debug**
        * Convenient logging during development & release in Swift 2 & 3   [SwiftyBeaver/SwiftyBeaver](https://github.com/SwiftyBeaver/SwiftyBeaver) ⭐️⭐️⭐️⭐️
        * A guard to help you check if you make UI changes not in main thread.  [olddonkey/ODUIThreadGuard](https://github.com/olddonkey/ODUIThreadGuard) ⭐️⭐️
        * Delightful console output for Swift developers. [onevcat/Rainbow](https://github.com/onevcat/Rainbow) ⭐️⭐️
        * An Xcode plugin let you build & run your selected lines of code in Xcode without running the whole project, you'll have the output instantly in your Xcode console. [wangshengjia/VWInstantRun](https://github.com/wangshengjia/VWInstantRun) ⭐️⭐️


    * <a name="ios-swift-Injection"></a>**Injection**
        * Modify your native iOS app in real time.  [krzysztofzablocki/Traits](https://github.com/krzysztofzablocki/Traits) ⭐️⭐️


    * <a name="ios-swift-OpenSource"></a>**OpenSource**
        * 📱 Collaborative List of Open-Source iOS Apps. [dkhamsing/open-source-ios-apps](https://github.com/dkhamsing/open-source-ios-apps) ⭐️⭐️⭐️⭐️⭐️⭐️⭐️⭐️⭐️  <sup>Awsome</sup>
        * Yep is a nifty and lightweight social networking app, revolving around the theme of "Meeting Genius", enabling users to find experts or other learners of a particular domain. [CatchChat/Yep](https://github.com/CatchChat/Yep) ⭐️⭐️⭐️⭐️⭐️
        * 爱鲜蜂By Swift2.0.  [ZhongTaoTian/LoveFreshBeen](https://github.com/ZhongTaoTian/LoveFreshBeen) ⭐️⭐️⭐️
        * Swift精仿知乎日报iOS端. [zpz1237/NirZhihuDaily2.0](https://github.com/zpz1237/NirZhihuDaily2.0) ⭐️⭐️
        * youtube iOS app template written in swift 3.  [aslanyanhaik/youtube-iOS](https://github.com/aslanyanhaik/youtube-iOS) ⭐️⭐️⭐️
        * Kickstarter for iOS. Bring new ideas to life, anywhere. [URL](https://github.com/kickstarter/ios-oss) ⭐️⭐️⭐️⭐️⭐️
        * The unofficial WWDC app for macOS.  [insidegui/WWDC](https://github.com/insidegui/WWDC) ⭐️⭐️⭐️⭐️⭐️
        * The Artsy Auction Kiosk App.  [artsy/eidolon](https://github.com/artsy/eidolon) ⭐️⭐️⭐️
        * Focus by Firefox. [mozilla-mobile/focus](https://github.com/mozilla-mobile/focus) ⭐️⭐️⭐️
        * Sources of iOS app 眼科行医手记 (CaseAssistant) using swift. [herrkaefer/CaseAssistant](https://github.com/herrkaefer/CaseAssistant) ⭐️
        * SwiftWeather is an iOS weather app developed in Swift 2. The app has been actively upgrading to adopt the latest features of iOS and Swift language. [JakeLin/SwiftWeather](https://github.com/JakeLin/SwiftWeather) ⭐️⭐️⭐️⭐️
        * try! Swift Conference App. [tryswift/trySwiftApp](https://github.com/tryswift/trySwiftApp) ⭐️⭐️


    * <a name="ios-swift-Mac&Tools"></a>**Mac&Tools**
        * The Swift code generator for your assets, storyboards, Localizable.strings, … — Get rid of all String-based APIs!  [SwiftGen/SwiftGen](https://github.com/SwiftGen/SwiftGen) ⭐️⭐️⭐️⭐️⭐️
        * Use iPic to upload images on macOS. [toolinbox/iPicUploader](https://github.com/toolinbox/iPicUploader) ⭐️
        * Swiftline is a set of tools to help you create command line applications. [oarrabi/Swiftline](https://github.com/oarrabi/Swiftline) ⭐️⭐️
        * An adorable little framework and command line tool for interacting with SourceKit. [jpsim/SourceKitten](https://github.com/jpsim/SourceKitten) ⭐️⭐️
        * A micro-framework for observing file changes, both local and remote. Helpful in building developer tools.[krzysztofzablocki/KZFileWatchers](https://github.com/krzysztofzablocki/KZFileWatchers) ⭐️⭐️
        * An unofficial 12306 Client for Mac.  [fancymax/12306ForMac](https://github.com/fancymax/12306ForMac) ⭐️⭐️⭐️  <sup>12306</sup>
        * The easiest way to get started with PostgreSQL on the Mac.  [PostgresApp/PostgresApp](https://github.com/PostgresApp/PostgresApp) ⭐️⭐️⭐️⭐️
        * Mac menubar app. Automate download daily picture from Microsoft Bing website and set it as your wallpaper. Written in Swift3. [zekunyan/TTGBingWallPaper](https://github.com/zekunyan/TTGBingWallPaper) ⭐️
        * A rule-based proxy for macOS. [zhuhaow/SpechtLite](https://github.com/zhuhaow/SpechtLite) ⭐️⭐️⭐️  <sup>proxy</sup>
        * A code library and command-line formatting tool for reformatting Swift code. [nicklockwood/SwiftFormat](https://github.com/nicklockwood/SwiftFormat) ⭐️⭐️⭐️
        * 📦 Mac App Store command line interface. [mas-cli/mas](https://github.com/mas-cli/mas) ⭐️⭐️⭐️⭐️
        * Xcode 8 Source Code Extension to Generate Swift Initializers.This Xcode 8 Source Code Extension will generate a Swift initializer based on the lines you've selected. Handy if you made a struct public and now you have to provide the initializer implementation yourself.  [Bouke/SwiftInitializerGenerator](https://github.com/Bouke/SwiftInitializerGenerator) ⭐️⭐️⭐️
        * A macOS command line tool that generates excellent Swift data models based on JSON data. [URL](https://github.com/ijoshsmith/json2swift) ⭐️⭐️
        * Xcode Source Editor Extension Tools (Xcode 8 Plugins) [cyanzhong/xTextHandler](https://github.com/cyanzhong/xTextHandler) ⭐️⭐️⭐️  <sup>Plugins</sup>
        * Easily generate cross platform Swift framework projects from the command line. [JohnSundell/SwiftPlate](https://github.com/JohnSundell/SwiftPlate) ⭐️⭐️
...
* <a name="ios-book"></a>**Book**
	...
	* Articles for objccn.io. objc.io的完整、准确、优雅的中文翻译版本. [articles](https://github.com/objccn/articles) ⭐️⭐️⭐️
    * 微博@iOS程序犭袁 的blog [ChenYilong/iOSBlog](https://github.com/ChenYilong/iOSBlog) ⭐️
    * How to create, develop, and distribute iOS Static Frameworks quickly and efficiently.  [jverkoey/iOS-Framework](https://github.com/jverkoey/iOS-Framework) ⭐️⭐️⭐️




* <a name="ios-tools"></a>**Tools**
    * Better playgrounds that work both for Objective-C and Swift. [krzysztofzablocki/KZPlayground](https://github.com/krzysztofzablocki/KZPlayground) ⭐️⭐️⭐️⭐️
	* 自动生成自签名HTTPS服务器，可以快速安装ipa、apk，基于ios-ipa-server开发 [ipapk-server](https://github.com/zhao0/ipapk-server) ⭐️⭐️
	* Apple ios automation. [smallapple](https://github.com/thebeet/smallapple) ⭐️⭐️⭐️
	* 📱 Automation for iOS, Android, and Windows Apps. [appium](https://github.com/appium/appium) ⭐️⭐️⭐️⭐️
	* Objective-c code Apple style documentation set generator.[appledoc](https://github.com/tomaz/appledoc) ⭐️⭐️⭐️⭐️
	* Flexible and fast xcodebuild formatter. [xcpretty](https://github.com/supermarin/xcpretty) ⭐️⭐️
	* 🚀 The easiest way to automate building and releasing your iOS and Android apps. [fastlane](https://github.com/fastlane/fastlane) ⭐️⭐️⭐️⭐️⭐️
	* Soulful docs for Swift & Objective-C.  [jazzy](https://github.com/realm/jazzy) ⭐️⭐️⭐️⭐️
	* No more messing with plugin UUIDs; Plugins on Xcode 8! [update_xcode_plugins](https://github.com/inket/update_xcode_plugins) ⭐️⭐️⭐️
	* MetaModel is designed to deal with model layer in iOS development with concise APIs which including data persistent, JSON to model and etc. [MetaModel](https://github.com/Primix/MetaModel) ⭐️⭐️
    ...
    * Bring some 12 factor love to your mobile apps! [luggit/react-native-config](https://github.com/luggit/react-native-config) ⭐️
    * Use SimSim to explore iOS application folders in Terminal or Finder. Fast, stable, free alternative to SimPholders. [dsmelov/simsim](https://github.com/dsmelov/simsim) ⭐️
    * iTunes connect reporting tool.  [hankinsoft/AppWage](https://github.com/hankinsoft/AppWage) ⭐️
    * Cordova iOS is an iOS application library that allows for Cordova-based projects to be built for the iOS Platform. Cordova based applications are, at the core, applications written with web technology: HTML, CSS and JavaScript. [apache/cordova-ios](https://github.com/apache/cordova-ios) ⭐️⭐️
    * A Mac app to decode and extract images from iOS apps, support png/jpg/ipa/Assets.car files. [devcxm/iOS-Images-Extractor](https://github.com/devcxm/iOS-Images-Extractor) ⭐️⭐️⭐️⭐️
    * a collection to solve app store review problem (ipv6,ipv6被拒绝,后台定位等审核问题的终极解决方案汇总).  [wg689/Solve-App-Store-Review-Problem](https://github.com/wg689/Solve-App-Store-Review-Problem) ⭐️⭐️⭐️
    * Runtime Code Injection for Objective-C & Swift. [johnno1962/injectionforxcode](https://github.com/johnno1962/injectionforxcode) ⭐️⭐️⭐️⭐️
    * Dynamic Code Injection Tool for Objective-C [DyCI/dyci-main](https://github.com/DyCI/dyci-main) ⭐️⭐️
    * Package manager for Xcode. [alcatraz/Alcatraz](https://github.com/alcatraz/Alcatraz) ⭐️⭐️⭐️⭐️
    * 转换Xcode控制台中一些不可阅读的字符，比如 \u22AD 这种.  [dhcdht/DXXcodeConsoleUnicodePlugin](https://github.com/dhcdht/DXXcodeConsoleUnicodePlugin) ⭐️
    * Code Pilot is an Xcode plugin which lets you woosh through your code and save a lot (and we mean a *lot*) of your time. [macoscope/CodePilot](https://github.com/macoscope/CodePilot) ⭐️⭐️
    * Apple TV Aerial Screensaver for Mac. [JohnCoates/Aerial](https://github.com/JohnCoates/Aerial)  ⭐️⭐️⭐️⭐️⭐️
...
* 30 days of React Native demos. [30-days-of-react-native](https://github.com/fangwei716/30-days-of-react-native) ⭐️⭐️⭐️⭐️⭐️
* A framework for building native apps with React. [react-native](https://github.com/facebook/react-native) ⭐️⭐️⭐️⭐️⭐️
* https://github.com/soliury/noder-react-native. [noder-react-native](https://github.com/soliury/noder-react-native) ⭐️⭐️
* React Native for macOS. [react-native-macos](https://github.com/ptmt/react-native-macos) ⭐️⭐️⭐️⭐️
* Source code of the official F8 app of 2016, powered by React Native and other Facebook open source projects. [f8app](https://github.com/fbsamples/f8app) ⭐️⭐️⭐️⭐️⭐️
* React Native开发嘎嘎商城客户端. [GaGaMall](https://github.com/gagakj/GaGaMall) ⭐️⭐️
...
* Device Information for React Native iOS and Android. [rebeccahughes/react-native-device-info](https://github.com/rebeccahughes/react-native-device-info) ⭐️
* Native iOS UITableView for React Native with JSON support and more. [aksonov/react-native-tableview](https://github.com/aksonov/react-native-tableview) ⭐️
* A collection of animated loading indicators for React Native. [maxs15/react-native-spinkit](https://github.com/maxs15/react-native-spinkit) ⭐️
* Rexxar 是一个针对移动端的混合开发框架。现在支持 Android 和 iOS 平台。Rexxar-iOS 是 Rexxar 在 iOS 系统上的客户端实现。[douban/rexxar-ios](https://github.com/douban/rexxar-ios) ⭐️
* OS X and iOS application and framework to play with the Apple Push Notification service (APNs) [noodlewerk/NWPusher](https://github.com/noodlewerk/NWPusher) ⭐️⭐️⭐️⭐️


##<a name="fe"></a>FE
* <a name="awesome-fe"></a>**Awesome**
...
* <a name="fe-react"></a>**React**
	...
	* A collection of ReactVR experiments (potentially also A-Frame and WebVR expriments using ReasonML & Elm). [experiments](https://github.com/nikgraf/webvr-experiments) ⭐️⭐️⭐️⭐️⭐️
	* A Virtual DOM and diffing algorithm. [virtual-dom](https://github.com/Matt-Esch/virtual-dom) ⭐️⭐️⭐️⭐️⭐️
	* a collection of simple demos of React.js. [react-demos](https://github.com/ruanyf/react-demos) ⭐️⭐️⭐️⭐️⭐️
	* Give your ReactJS components routes. [junctions](https://github.com/jamesknelson/junctions) ⭐️⭐️
	* Declarative routing for React.[react-router](https://github.com/ReactTraining/react-router) ⭐️⭐️⭐️⭐️⭐️
	* 🎩 A universal React-compatible render engine. [rax](https://github.com/alibaba/rax) ⭐️⭐️⭐️⭐️
	* Transform plain text into dynamic blogs and websites using React.js.  [gatsby](https://github.com/gatsbyjs/gatsby) ⭐️⭐️⭐️⭐️
	* Framework for server-rendered React apps. [next.js](https://github.com/zeit/next.js) ⭐️⭐️⭐️⭐️⭐️
...
* <a name="#fe-vue"></a>**Vue**
	...
	* HackerNews clone built with Vue 2.0, vue-router & vuex, with server-side rendering.[vue-hackernews](https://github.com/vuejs/vue-hackernews-2.0) ⭐️⭐️⭐️
...
* <a name="#fe-node"></a>**Node**
	...
	* simple, flexible, fun javascript test framework for node.js & the browser. [mocha](https://github.com/mochajs/mocha) ⭐️⭐️⭐️⭐️
	* tiny node.js & browser debugging utility for your libraries and applications. [visionmedia/debug](https://github.com/visionmedia/debug) ⭐️⭐️⭐️
* <a name="fe-bootstrap"></a>**Bootstrap**
	* The most popular HTML, CSS, and JavaScript framework for developing responsive, mobile first projects on the web. [bootstrap](https://github.com/twbs/bootstrap) ⭐️⭐️⭐️⭐️⭐️
	* Bootstrap 3 components built with React [react-bootstrap](https://github.com/react-bootstrap/react-bootstrap) ⭐️⭐️⭐️⭐️

* <a name="fe-electron"></a>**Electron**
	* Build cross platform desktop apps with JavaScript, HTML, and CSS.  [electron](https://github.com/electron/electron) ⭐️⭐️⭐️⭐️⭐️
	* Clone to try a simple Electron app. [electron-quick-start](https://github.com/electron/electron-quick-start) ⭐️⭐️⭐️⭐️
	* Test Electron apps using ChromeDriver.  [spectron](https://github.com/electron/spectron) ⭐️⭐️
	* 💬 A better WeChat on macOS and Linux. Built with Electron by Zhongyi Tong. [electronic-wechat](https://github.com/geeeeeeeeek/electronic-wechat) ⭐️⭐️⭐️⭐️⭐️
* <a name="fe-redux"></a>**Redux**
	* Predictable state container for JavaScript apps. [redux](https://github.com/reactjs/redux) ⭐️⭐️⭐️⭐️⭐️
	* Selector library for Redux. [reselect](https://github.com/reactjs/reselect) ⭐️⭐️⭐️
	* Official React bindings for Redux. [react-redux](https://github.com/reactjs/react-redux) ⭐️⭐️⭐️⭐️
	* RxJS middleware for action side effects in Redux using "Epics". [redux-observable](https://github.com/redux-observable/redux-observable) ⭐️⭐️⭐️

* <a name="fe-javascript"></a>**JavaScript**
	* JavaScript Style Guide. [airbnb/javascript](https://github.com/airbnb/javascript) ⭐️⭐️⭐️⭐️⭐️
	* 《ECMAScript 6入门》是一本开源的JavaScript语言教程，全面介绍ECMAScript 6新增的语法特性。[es6tutorial](https://github.com/ruanyf/es6tutorial) ⭐️⭐️⭐️⭐️⭐️
	* Module bundler with support for code splitting, ES6 & CommonJS modules. [splittable](https://github.com/cramforce/splittable) ⭐️⭐️
	* Turn your ES5 code into readable ES6 (sugar-syntax). It does the opposite of what Babel does.[lebab](https://github.com/lebab/lebab) ⭐️⭐️⭐️⭐️
	* The second edition of Eloquent JavaScript. [Eloquent-JavaScript](https://github.com/marijnh/Eloquent-JavaScript) ⭐️⭐️⭐️
	* Firebase Quickstart Samples for Web.[quickstart-js](https://github.com/firebase/quickstart-js) ⭐️⭐️
	* after effects to html library. [bodymovin](https://github.com/bodymovin/bodymovin) ⭐️⭐️
	* 🛁 Clean Code concepts adapted for JavaScript. [clean-code-javascript](https://github.com/ryanmcdermott/clean-code-javascript) ⭐️⭐️⭐️
	* 🐏 Practical functional Javascript. [ramda](https://github.com/ramda/ramda) ⭐️⭐️⭐️⭐️⭐️
	* A book about functional programming in JavaScript. [Functional-Light-JS](https://github.com/getify/Functional-Light-JS) ⭐️⭐️⭐️⭐️⭐️
	* a functional programming library for javascript. an experiment in elegant JS. [lemonad](https://github.com/fogus/lemonad) ⭐️⭐️
	* Prettier is an opinionated JavaScript formatter. [prettier](https://github.com/prettier/prettier) ⭐️⭐️⭐️⭐️
	* A JavaScript code analyzer for deep, cross-editor language support. [ternjs](https://github.com/ternjs/tern) ⭐️⭐️⭐️
	* To be, or not to be, that is a question! 😂 万剑归宗的无名和独霸天下的雄霸. [effective-javascript](https://github.com/dreamapplehappy/effective-javascript) ⭐️⭐️⭐️
	* 🐠 Babel is a compiler for writing next generation JavaScript. [babel](https://github.com/babel/babel) ⭐️⭐️⭐️⭐️⭐️
...
* <a name="fe-component"></a>**Component**
	...
	* Generate regular expressions that match a set of strings.[regexgen](https://github.com/devongovett/regexgen) ⭐️⭐️⭐️⭐️
	* 🍃 JavaScript library for mobile-friendly interactive **maps**. [Leaflet](https://github.com/Leaflet/Leaflet) ⭐️⭐️⭐️⭐️⭐️
	* JavaScript image gallery for mobile and desktop, modular, framework independent. [PhotoSwipe](https://github.com/dimsemenov/PhotoSwipe) ⭐️⭐️⭐️⭐️
	* Medium's Image Zoom for jQuery.[zoom.js](https://github.com/fat/zoom.js) ⭐️⭐️⭐️
	* The official jQuery user interface library.[jquery-ui](https://github.com/jquery/jquery-ui) ⭐️⭐️⭐️
	* Select2 is a jQuery based replacement for select boxes. It supports searching, remote data sets, and infinite scrolling of results. [select2](https://github.com/select2/select2) ⭐️⭐️⭐️⭐️
	* super tiny size multi-touch gestures library for the web. [AlloyFinger](https://github.com/AlloyTeam/AlloyFinger) ⭐️⭐️⭐️⭐️
	* Dead simple Javascript animated typing, with no dependencies.[ityped](https://github.com/luisvinicius167/ityped) ⭐️⭐️
	* Riding carousels with jQuery.[jcarousel](https://github.com/jsor/jcarousel) ⭐️⭐️⭐️
	* a clean and simple notification, input, and selection suite for javascript, with no dependencies. [notie](https://github.com/jaredreich/notie) ⭐️⭐️⭐️
	* SUI Mobile (MSUI)是由阿里巴巴国际UED前端出品的移动端UI库，轻量精美. [SUI-Mobile](https://github.com/sdc-alibaba/SUI-Mobile) ⭐️⭐️⭐️⭐️
	* Morph DOM elements from one state to another with smooth animations and transitions. [ramjet](https://github.com/Rich-Harris/ramjet) ⭐️⭐️⭐️
	* Parse, validate, manipulate, and display **dates** in javascript. [moment](https://github.com/moment/moment) ⭐️⭐️⭐️
	* Lightweight and powerful datetimepicker with no dependencies. [flatpickr](https://github.com/chmln/flatpickr) ⭐️⭐️⭐️⭐️
	* jQuery Plugin for Sticky Objects. [sticky](https://github.com/garand/sticky) ⭐️⭐️
	* Medium.com WYSIWYG editor clone. Uses contenteditable API to implement a rich text solution.  [medium-editor](https://github.com/yabwe/medium-editor) ⭐️⭐️⭐️⭐️⭐️
	* A React framework for building text **editors**. [facebook/draft-js](https://github.com/facebook/draft-js) ⭐️⭐️⭐️⭐️⭐️
	* A completely customizable framework for building rich text editors.  [slate](https://github.com/ianstormtaylor/slate) ⭐️⭐️⭐️
	* Get caret postion and offset from text field. [Caret.js](https://github.com/ichord/Caret.js) ⭐️
...
* <a name="fe-canvas"></a>**Canvas**
	...
	* An image effects library for JavaScript using WebGL. [glfx.js](https://github.com/evanw/glfx.js) ⭐️⭐️
	* A real time javascript webm encoder based on a canvas hack. [whammy](https://github.com/antimatter15/whammy) ⭐️
	* turbo.js - perform massive parallel computations in your browser with GPGPU. [turbo/js](https://github.com/turbo/js) ⭐️⭐️⭐️
	* JavaScript tweening engine for easy animations, incorporating optimised Robert Penner's equations. [tween.js](https://github.com/tweenjs/tween.js) ⭐️⭐️⭐️⭐️⭐️
	* ✂️ Modern copy to clipboard. No Flash. Just 3kb gzipped 📋.  [clipboard.js](https://github.com/zenorocha/clipboard.js) ⭐️⭐️⭐️⭐️⭐️
	* A simple web-based tool for Spriting and Pixel art. [piskel](https://github.com/juliandescottes/piskel) ⭐️⭐️
	* A web framework for building <mark>virtual reality</mark> experiences.[aframe](https://github.com/aframevr/aframe) ⭐️⭐️⭐️⭐️⭐️ <sup><mark>VR</mark></sup>
	* a 2D rigid body physics engine for the web ▲● ■  [matter-js](https://github.com/liabru/matter-js) ⭐️⭐️⭐️⭐️
	* The open source JavaScript graphing library that powers plotly.   [plotly.js](https://github.com/plotly/plotly.js) ⭐️⭐️⭐️
	* Low-Poly Image and Video Processing. [Polyvia](https://github.com/Ovilia/Polyvia) ⭐️⭐️⭐️⭐️⭐️ ![image](https://raw.githubusercontent.com/Ovilia/Polyvia/gh-pages/src/img/2.png)
	* 🎨 Generative artwork in node/browser based on a seeded random. [color-wander](https://github.com/mattdesl/color-wander) ⭐️⭐️⭐️⭐️ 
	* Parse collada .dae 3d animation files into a WebGL friendly JSON format. [collada-dae-parser](https://github.com/chinedufn/collada-dae-parser) ⭐️
	* Bring data to life with SVG, Canvas and HTML. 📊📈🎉  [d3](https://github.com/d3/d3) ⭐️⭐️⭐️⭐️⭐️⭐️⭐️⭐️⭐️⭐️
	* A javascript library that extends D3.js to enable fast and beautiful visualizations. [d3plus](https://github.com/alexandersimoes/d3plus) ⭐️⭐️⭐️⭐️
	* A reusable charting library written in d3.js [nvd3](https://github.com/novus/nvd3) ⭐️⭐️⭐️⭐️⭐️
	* Mozaïk is a tool based on nodejs / react / d3 to easily craft beautiful dashboards. [mozaik](https://github.com/plouc/mozaik) ⭐️⭐️⭐️
	* A powerful, interactive charting and visualization library for browser. [echarts](https://github.com/ecomfe/echarts) ⭐️⭐️⭐️
...
* <a name="fe-media"></a>**Media**
    ...
    * An iOS and macOS audio visualization framework built upon Core Audio useful for anyone doing real-time, low-latency audio processing and visualizations. [syedhali/EZAudio](https://github.com/syedhali/EZAudio) ⭐️⭐️⭐️⭐️
...
* <a name="fe-wechat"></a>**微信**
	...
	* 微信小程序 web 端实时运行工具. [wept](https://github.com/chemzqm/wept) ⭐️⭐️
	* 小程序组件化开发框架. [wepy](https://github.com/wepyjs/wepy) ⭐️
	* wxParse-微信小程序富文本解析自定义组件，支持HTML及markdown解析. [wxParse](https://github.com/icindy/wxParse) ⭐️⭐️⭐️
	* 使用 LeanEngine 的微信公众号自动问答机器人的演示项目. [LeanEngine-WechatBot](https://github.com/leancloud/LeanEngine-WechatBot) ⭐️
	* 【应用号】IDE + 破解 + Demo. [weapp-ide-crack](https://github.com/gavinkwoe/weapp-ide-crack) ⭐️⭐️⭐️
	* 微信小应用资源汇总整理. [awesome-wechat-weapp](https://github.com/Aufree/awesome-wechat-weapp) ⭐️⭐️
	* 微信小程序开发资源汇总 💯 [awesome-wechat-weapp](https://github.com/justjavac/awesome-wechat-weapp) ⭐️⭐️⭐️⭐️
	* gank(小程序项目) [URL](https://github.com/lypeer/wechat-weapp-gank) ⭐️⭐️
...
* <a name="fe-package"></a>**Package**
	...
	* Flow is a static typechecker for JavaScript. To find out more about Flow [yarn](https://github.com/yarnpkg/yarn) ⭐️⭐️⭐️⭐️⭐️ <sup>npm</sup>
	* 🐉 A tool for managing JavaScript projects with multiple packages. [lerna](https://github.com/lerna/lerna) ⭐️⭐️⭐️
	* Prerenders static HTML in a single-page application.[prerender-spa-plugin](https://github.com/chrisvfritz/prerender-spa-plugin) <sup>webpack</sup> ⭐️⭐️⭐️
	* A CLI dashboard for webpack dev server.  [webpack-dashboard](https://github.com/FormidableLabs/webpack-dashboard) ⭐️⭐️⭐️⭐️

* <a name="fe-tools"></a>**Tools**
	* Adds static typing to JavaScript to improve developer productivity and <mark>code quality</mark>. [facebook/flow](https://github.com/facebook/flow) ⭐️⭐️⭐️⭐️⭐️
	* ⚡️ Web Debugging Proxy based on Chrome DevTools Network panel. [betwixt](https://github.com/kdzwinel/betwixt) ⭐️⭐️⭐️
    ...
    * LiveReload.app for Mac and Windows. See “develop” branch for the latest Windows release and LiveReload 3 progress. (NOTE: renamed from LiveReload2.)  [livereload/LiveReload](https://github.com/livereload/LiveReload) ⭐️⭐️
...
* <a name="fe-other"></a>**Other**
	...
	* Hackable HTTP <mark>proxy</mark> to simulate server failure scenarios and network conditions.[toxy](https://github.com/h2non/toxy) ⭐️⭐️
	* Yet another JS code coverage tool that computes statement, line, function and branch coverage with module loader hooks to transparently add coverage when running tests. Supports all JS coverage use cases including <mark>unit tests</mark>, server side functional tests and browser tests. Built for scale.[istanbul](https://github.com/gotwarlost/istanbul) ⭐️⭐️⭐️
	* 一个可以把js源代码压缩成一个ascii字符画的源代码的工具，压缩后的代码仍可运行 （A tool can compress JavaScript code to any ascii image and still run normally ) [js2image](https://github.com/xinyu198736/js2image) ⭐️⭐️
	* ⛄️ Possibly the smallest compiler ever .[the-super-tiny-compiler](https://github.com/thejameskyle/the-super-tiny-compiler) ⭐️⭐️⭐️⭐️⭐️
	* a clean and simple notification, input, and selection suite for javascript, with no dependencies. [URL](https://github.com/jaredreich/notie) ⭐️⭐️⭐️
	* 🏩 A simple process manager for developers. Start apps from your browser and access them using local .dev domains.[hotel](https://github.com/typicode/hotel) ⭐️⭐️⭐️⭐️
	* Code tree for GitHub and GitLab. [octotree](https://github.com/buunguyen/octotree) ⭐️⭐️⭐️⭐️
	* 文曲星模拟器. [jswqx](https://github.com/hackwaly/jswqx) ⭐️⭐️⭐️



##<a name="server"></a>Server
* <a name="server-node"></a>**Node**
	* Node.js JavaScript runtime ✨🐢🚀✨  [node](https://github.com/nodejs/node) ⭐️⭐️⭐️⭐️⭐️
	* Call all Node.js modules directly from DOM and enable a new way of writing applications with all Web technologies. [nw.js](https://github.com/nwjs/nw.js) ⭐️⭐️⭐️⭐️⭐️
	* 一起学 Node.js. [N-blog](https://github.com/nswbmw/N-blog) ⭐️⭐️⭐️⭐️⭐️
	* 🐤Nodeclub 是使用 Node.js 和 MongoDB 开发的社区系统. [nodeclub](https://github.com/cnodejs/nodeclub) ⭐️⭐️⭐️⭐️⭐️
	* Fast, cross-platform, standalone ClojureScript REPL. [URL](https://github.com/anmonteiro/lumo) ⭐️
	* Born to build better enterprise frameworks and apps with Node.js & koa.[egg](https://github.com/eggjs/egg) ⭐️⭐️
	* Node Version Manager - Simple bash script to manage multiple active node.js versions.[nvm](https://github.com/creationix/nvm) ⭐️⭐️⭐️⭐️⭐️
	* A fully configurable http/https proxy in NodeJS.[anyproxy](https://github.com/alibaba/anyproxy) ⭐️⭐️⭐️⭐️
	* ⚡️ The one-liner node.js http-proxy middleware for connect, express and browser-sync.[http-proxy-middleware](https://github.com/chimurai/http-proxy-middleware) ⭐️⭐️
	* ✨☁️📁✨ Cloud Commander is an orthodox web file manager with console and editor. [cloudcmd](https://github.com/coderaiser/cloudcmd) ⭐️⭐️
	* Give your JS App some Backbone with Models, Views, Collections, and Events.  ⭐️⭐️⭐️⭐️
	* Exploits locked/password protected computers over USB, drops persistent WebSocket-based backdoor, exposes internal router, and siphons cookies using Raspberry Pi Zero & Node.js. [poisontap](https://github.com/samyk/poisontap) ⭐️⭐️⭐️
	* Minimalistic BDD-style assertions for Node.JS and the browser. [expect.js](https://github.com/Automattic/expect.js) ⭐️⭐️⭐️
	* BDD style assertions for node.js -- test framework agnostic. [should.js](https://github.com/tj/should.js) ⭐️⭐️⭐️
	* ☕️ 👻 Run client-side mocha tests in the command line through phantomjs. [mocha-phantomjs](https://github.com/nathanboktae/mocha-phantomjs) ⭐️⭐️
	* Obsolete polyfill for the ServiceWorker cache API. Chrome 46 and Opera 33 support addAll now. [cache-polyfill](https://github.com/dominiccooney/cache-polyfill) ⭐️
	* A node.js module for parsing form data, especially file uploads. [node-formidable](https://github.com/felixge/node-formidable) ⭐️⭐️⭐️
	* An IMAP client module for node.js.  [node-imap](https://github.com/mscdex/node-imap) ⭐️⭐️
	* Native Node bindings to Git. [nodegit](https://github.com/nodegit/nodegit) ⭐️⭐️⭐️
	* Realtime MVC Framework for Node.js. [sails](https://github.com/balderdashy/sails) ⭐️⭐️⭐️⭐️
	* Simple, unobtrusive authentication for Node.js. [passport](https://github.com/jaredhanson/passport) ⭐️⭐️⭐️⭐️
	* Node.js implementation of <mark>HomeKit</mark> Accessory Server.[HAP-NodeJS](https://github.com/KhaosT/HAP-NodeJS) ⭐️⭐️⭐️⭐️
	* Pug – robust, elegant, feature rich template engine for Node.js  [pugjs/pug](https://github.com/pugjs/pug) ⭐️⭐️⭐️⭐️
	* Embedded JavaScript templates for node.  [ejs](https://github.com/tj/ejs) ⭐️⭐️⭐️⭐️
	* MEAN (Mongo, Express, Angular, Node) - A Simple, Scalable and Easy starting point for full stack javascript web development - utilizing many of the best practices we've found on the way.  [mean](https://github.com/linnovate/mean) ⭐️⭐️⭐️⭐️⭐️
...
* <a name="server-swift"></a>**Swift**
    * Server-side Swift. The Perfect core toolset and framework for Swift Developers. (For mobile back-end development, website and API development, and more…) [https://www.perfect.org](https://www.perfect.org)  [PerfectlySoft/Perfect](https://github.com/PerfectlySoft/Perfect) ⭐️⭐️⭐️⭐️⭐️⭐️⭐️
    * A Swift web framework and HTTP server. [IBM-Swift/Kitura](https://github.com/IBM-Swift/Kitura) ⭐️⭐️⭐️⭐️⭐️
    * A web framework and server for Swift that works on macOS and Ubuntu. [vapor/vapor](https://github.com/vapor/vapor) ⭐️⭐️⭐️⭐️⭐️
    * Send email to any SMTP server like a boss, in Swift and cross-platform.  [onevcat/Hedwig](https://github.com/onevcat/Hedwig) ⭐️⭐️
    * HTTP Implementation for Swift on Linux and Mac OS X. [huytd/swift-http](https://github.com/huytd/swift-http) ⭐️
    * A toolkit for Network Extension Framework. [zhuhaow/NEKit](https://github.com/zhuhaow/NEKit) ⭐️⭐️⭐️
    * A Ruby on Rails inspired Web Framework for Swift that runs on Linux and OS X.  [necolt/Swifton](https://github.com/necolt/Swifton) ⭐️⭐️⭐️


* <a name="server-ruby"></a>**Ruby**
	* A repository of geographic regions for Ruby.  [carmen](https://github.com/jim/carmen) ⭐️⭐️
	* GitLab CE | Please open new issues in our issue tracker on GitLab.com [gitlabhq](https://github.com/gitlabhq/gitlabhq) ⭐️⭐️⭐️⭐️
	* Classier solution for file uploads for Rails, Sinatra and other Ruby web frameworks. [carrierwave](https://github.com/carrierwaveuploader/carrierwave) ⭐️⭐️⭐️
	* Simple, efficient background processing for Ruby.  [sidekiq](https://github.com/mperham/sidekiq) ⭐️⭐️⭐️
...
##<a name="ue"></a>UI/UE
* <a name="ue-sketch"></a>**Sketch**
	* Sketch plugin that lets you save and load colors in the color picker [sketch-palettes](https://github.com/andrewfiorillo/sketch-palettes) ⭐️⭐️
    ...
    * [Sketch Plugin] Sketch-flavored Auto Layout-like Constraints.  [matt-curtis/Fluid-for-Sketch](https://github.com/matt-curtis/Fluid-for-Sketch) ⭐️⭐️⭐️
...
* A Quartz Composer framework that enables interactive design prototyping without programming.  [facebookarchive/origami](https://github.com/facebookarchive/origami) ⭐️⭐️⭐️⭐️
...
* Xcode plugin for Vim keybindings.  [XVimProject/XVim](https://github.com/XVimProject/XVim) ⭐️⭐️⭐️⭐️
...
* The Git interface you've been missing all your life has finally arrived. [git-up/GitUp](https://github.com/git-up/GitUp) ⭐️⭐️⭐️⭐️⭐️


## <a name="distribution-plan"></a>部署方案
* <a name="distribution-plan-data-visible"></a>**可视化**
...
* <a name="distribution-plan-vpn"></a>**VPN**
	...
	* Scripts to build your own IPsec VPN server, with IPsec/L2TP and Cisco IPsec on Ubuntu, Debian and CentOS. [setup-ipsec-vpn](https://github.com/hwdsl2/setup-ipsec-vpn) ⭐️⭐️⭐️⭐️
	* 使用XX-Net科学上网. [XX-Net](https://github.com/XX-net/XX-Net) ⭐️⭐️⭐️⭐️⭐️

* <a name="distribution-plan-tools"></a>**Tools**
	* A tool that forces any TCP connection made by any given application to follow through proxy like TOR or any other SOCKS4, SOCKS5 or HTTP(S) proxy. Supported auth-types: "user/pass" for SOCKS4/5, "basic" for HTTP.[proxychains](https://github.com/haad/proxychains) ⭐️⭐️⭐️
...
* <a name="#distribution-plan-data-analytics"></a>**数据分析**
	...
	* This is the home for Countly Mobile & Web Analytics and Marketing Platform. Countly helps you collect data and understand insights of your application. Available self-hosted or on private cloud. [countly-server](https://github.com/Countly/countly-server) ⭐️⭐️
	* Vector is an on-host performance monitoring framework which exposes hand picked high resolution metrics to every engineer’s browser. [vector](https://github.com/Netflix/vector) ⭐️⭐️⭐️
	* 
* <a name="distribution-plan-framework"></a>**Framework**
	* A light-weight RPC implement of google protobuf RPC framework. [sofa-pbrpc](https://github.com/baidu/sofa-pbrpc) ⭐️⭐️⭐️ <sup>RPC</sup>
	* Google's common Java, C++ and JavaScript library for parsing, formatting, and validating international phone numbers. [libphonenumber](https://github.com/googlei18n/libphonenumber)  ⭐️⭐️⭐️⭐️⭐️
	* Compile-time C Compiler implemented as C++14 constant expressions.  [constexpr-8cc](https://github.com/kw-udon/constexpr-8cc) ⭐️⭐️
...
* EasyDarwin开源流媒体平台.  [EasyDarwin](https://github.com/EasyDarwin/EasyDarwin) ⭐️⭐️
...
* TextMate is a graphical text editor for OS X 10.8+  [textmate/textmate](https://github.com/textmate/textmate) ⭐️⭐️⭐️⭐️⭐️
* 💀 Mac app to block your own access to distracting websites etc for a predetermined period of time. It can not be undone by the app or by a restart – you must wait for the timer to run out. [SelfControlApp/selfcontrol](https://github.com/SelfControlApp/selfcontrol) ⭐️⭐️
...
* <a name="other-tools"></a>**工具**
    * Spectacle allows you to organize your windows without using a mouse. [eczarny/spectacle](https://github.com/eczarny/spectacle) ⭐️⭐️⭐️⭐️⭐️
    * Automatic tiling window manager for macOS à la xmonad.  [ianyh/Amethyst](https://github.com/ianyh/Amethyst) ⭐️⭐️⭐️
	...
	* 阿里云 OSS Ruby 上传组件，基于 Carrierwave.  [carrierwave-aliyun](https://github.com/huacnlee/carrierwave-aliyun) ⭐️⭐️
...
* <a name="other-other"></a>**Other Framework & Engine**
	* Modern C++14 game engine with Vulkan support, fully featured editor and C# scripting. [BansheeEngine](https://github.com/BearishSun/BansheeEngine) ⭐️⭐️
	* Godot Engine – Multi-platform 2D and 3D game engine. [godot](https://github.com/godotengine/godot) ⭐️⭐️
	* CRYENGINE is a powerful real-time game development platform created by Crytek. [CRYENGINE](https://github.com/CRYTEK-CRYENGINE/CRYENGINE) ⭐️⭐️⭐️
	* Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library. [bgfx](https://github.com/bkaradzic/bgfx) ⭐️⭐️⭐️
	* MIT Licensed Open Source version of Torque 3D from GarageGames. [Torque3D](https://github.com/GarageGames/Torque3D) ⭐️⭐️
